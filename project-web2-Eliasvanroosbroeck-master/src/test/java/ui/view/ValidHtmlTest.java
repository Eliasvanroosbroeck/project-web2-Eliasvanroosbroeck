...
public class ValidHtmlTest {
    ...
    public void isValidHtmlHome() {
        ...
        invulveld.sendKeys("http://cyclone3.uclllabs.be:8081/elias-vanroosbroeck_war/");
    ...
    public void isValidHtmlVoegToe() {
        ...
        // verander naar de url die je wil valideren
        invulveld.sendKeys("http://cyclone3.uclllabs.be:8081/elias-vanroosbroeck_war/Servlet?command=voegToe");
        WebElement button = driver.findElement(By.id("submit"));
        button.click();
        WebElement pass = driver.findElement(By.cssSelector("#results .success"));
        assertEquals("The document is valid HTML5 + ARIA + SVG 1.1 + MathML 2.0 (subject to the utter previewness of this service).", pass.getText());
    ...
    public void isValidHtmlOverzicht() {
        ...
        // verander naar de url die je wil valideren
        invulveld.sendKeys("http://cyclone3.uclllabs.be:8081/elias-vanroosbroeck_war/Servlet?command=overzicht");
        WebElement button = driver.findElement(By.id("submit"));
        button.click();
        WebElement pass = driver.findElement(By.cssSelector("#results .success"));
        assertEquals("The document is valid HTML5 + ARIA + SVG 1.1 + MathML 2.0 (subject to the utter previewness of this service).", pass.getText());
    ...
    public void isValidHtmlZoek() {
        ...
        // verander naar de url die je wil valideren
        invulveld.sendKeys("http://cyclone3.uclllabs.be:8081/elias-vanroosbroeck_war/Servlet?command=zoek");
        WebElement button = driver.findElement(By.id("submit"));
        button.click();
        WebElement pass = driver.findElement(By.cssSelector("#results .success"));
        assertEquals("The document is valid HTML5 + ARIA + SVG 1.1 + MathML 2.0 (subject to the utter previewness of this service).", pass.getText());
